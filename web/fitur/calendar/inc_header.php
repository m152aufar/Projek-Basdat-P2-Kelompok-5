        ...
        <div class="wrapper">
            ...
            <div class="menu">
                ...
                <li><a href="http://localhost/web/index.php">Home</a></li>
                    <li><a href="http://localhost/web/task_list/halaman.php">Task List</a></li>
                    <li><a href="http://localhost/web/calendar/dynamic-full-calendar.html">Calendar</a></li>
                    <li><a href="http://localhost/web/trial/timer.php">Timer</a></li>
